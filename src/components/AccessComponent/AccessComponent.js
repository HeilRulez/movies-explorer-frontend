...
export default function AccessComponent({ link, linkPreText, linkText, headerText, btnText, onSubmite, colorStyle }) {
    ...
    <section className ='login'>
      ...
      <form className='form' onSubmit={handleSubmit} name='signin' noValidate>
        ...
        <div>
          ...
          <p className="login__text-forLink">
            {linkPreText}
            <Link className="login__link" to={link}>{linkText}</Link>
          </p>
        </div>
      </form>
    </section>
